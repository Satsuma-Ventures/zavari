...
- **Marketing landing:** brief written to `artifacts/1-3-landing-brief.md` and committed; framing approved (**blend** — leads with concept direction "intelligence-not-insurance / first-party-led", keeps "strategic intelligence OS" category line prominent). **Pushed to Project 1 as `marketing/LANDING_BRIEF.md`. ⏸ Awaiting founder generation in claude.ai/design**, then sync to `docs/` root as `index.html`.
